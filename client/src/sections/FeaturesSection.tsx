    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                   Our Ai understands your objective and works on the demand for modern annotations...
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your views with AI optimised systems... </h3>
                        <p className="text-slate-300 mt-2">So what are you waiting for go ahead and start your journey to become a unique one...</p>
