        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    <Link to='/my-generation' className="hover:text-pink-500 transition">My Generation
                    </Link>
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                    ...
                    <Link onClick={() => setIsOpen(false)} to='/generate'>Generate
                    </Link>

                    <Link onClick={() => setIsOpen(false)} to='/my-generation'>My Generation
                    </Link>

                    <Link onClick={() => setIsOpen(false)} to='#'>Contact
                    </Link>

                    <Link onClick={() => setIsOpen(false)} to='/login'>Login
                    </Link>
